...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function data = Francois_T_R_VNA_log()
...
% Initialize VNA Data
data=struct('time',[],'T_A',[],'T_B',[],'freqList',[],'VNA_trace',[], 'lockin_R', [], 'lockin_theta', [], 'resistance', []);
...
VNA.trigger;
data.VNA_trace(T_n)=VNA.getSingleTrace();
