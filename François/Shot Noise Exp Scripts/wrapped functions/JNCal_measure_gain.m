...
function JNCal_measure_gain(UniqueName, start_dir, numberOfSamples, numberOfAverages, numberOfCycles, tempWaitTime, temperatureWindow, tempRampRate, fftMask, resistance, leadResistance, range, gateVoltageList, tempList, lockInTimeConstant)
