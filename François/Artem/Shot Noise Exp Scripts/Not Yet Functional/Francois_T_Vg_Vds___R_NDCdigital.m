...
function Francois_T_Vg_Vds___R_NDCdigital(UniqueName, start_dir, numberOfSamples, numberOfAverages, numberOfDCCycles, tempWaitTime, temperatureWindow, tempRampRate, fftMask, resistance, leadResistance, range, gateVoltageList, tempList, lockInTimeConstant,  resistanceMeasExcitationCurrent)
