...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function data = Francois_Ndc_Nac_R_T__T_Vg_Idc(T_list,Vg_list, Idc_list, Iac,...
    ...
    function plotVvI(T_n,Vg_n)
        ...
        plot(squeeze(1E3*data.Idc(mask)), 1E3*squeeze(data.Vsd(T_n,Vg_n,mask)),'.-','MarkerSize',15);
        hold all;
    ...
    function measure_data(T_n,Vg_n,Idc_n)
        ...
        data.std.VNac_Y(T_n,Vg_n,Idc_n) = std(data.raw.VNac_X(T_n,Vg_n,Idc_n,:));
    end
