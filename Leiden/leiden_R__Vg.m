...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function data = leiden_R__Vg(Vg_list, SD_Vex, Nmeasurements, VWaitTime1, VWaitTime2,...
    measurementWaitTime, Vg_rampRate, SD_Rex, EmailJess, EmailKC, UniqueName)
...
if max(abs(Vg_list)) <= 2.5
    goon = input('Gate voltage set above 2.5 V, are you sure? Y/N');
    if goon ~= 'Y'
        error('Exiting')
    end
end
